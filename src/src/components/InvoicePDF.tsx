    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs print:p-0 print:bg-white print:relative print:z-0">
      ...
      >
        ...
        >
          ...
          <div className="bg-stone-50 rounded-xl p-3 border border-stone-200 text-[10px] text-stone-600 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <div>
              <span className="font-bold text-stone-800">Rekening Resmi Pembayaran:</span>{' '}
              <span>Bank BPD DIY ([003] Cabang Wates) No. Rek <strong>003.211.005851</strong> a.n <strong>TRIYANTO RAHARJO, S.Sos., M.Si.</strong></span>
            </div>
            <span className="font-mono text-stone-500 font-semibold shrink-0">NMID: ID1025401239294</span>
          </div>
